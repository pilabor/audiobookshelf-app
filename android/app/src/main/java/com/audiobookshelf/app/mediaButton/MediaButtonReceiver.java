package com.audiobookshelf.app.mediaButton;
/*
...
public class MediaButtonReceiver extends BroadcastReceiver {
  ...
  protected String keyEventToString(@Nullable KeyEvent keyEvent) {
    if(keyEvent == null) {
      return "keyEvent is <null>";
    }
    String action = switch(keyEvent.getAction()) {
      case KeyEvent.ACTION_UP -> "ACTION_UP";
      case KeyEvent.ACTION_DOWN -> "ACTION_DOWN";
      default -> "ACTION_UNKNOWN";
    };

    String keyCode = switch(keyEvent.getKeyCode()) {
      case KeyEvent.KEYCODE_HEADSETHOOK -> "KEYCODE_HEADSETHOOK";
      case KeyEvent.KEYCODE_MEDIA_PLAY -> "KEYCODE_MEDIA_PLAY";
      case KeyEvent.KEYCODE_MEDIA_PAUSE -> "KEYCODE_MEDIA_PAUSE";
      case KeyEvent.KEYCODE_MEDIA_PLAY_PAUSE -> "KEYCODE_MEDIA_PLAY_PAUSE";
      case KeyEvent.KEYCODE_MEDIA_NEXT -> "KEYCODE_MEDIA_NEXT";
      case KeyEvent.KEYCODE_MEDIA_PREVIOUS -> "KEYCODE_MEDIA_PREVIOUS";
      case KeyEvent.KEYCODE_MEDIA_STOP -> "KEYCODE_MEDIA_STOP";
      default -> "KEYCODE_UNKNOWN";
    };
    return String.format("keyCode=%s, action=%s, repeatCount=%d, eventTime=%d, downTime=%d", keyCode, action, keyEvent.getRepeatCount(), keyEvent.getEventTime(), keyEvent.getDownTime());
  }
  ...
  public final void onReceive(Context context, @Nullable Intent intent) {
    ...
    android.util.Log.d(TAG, "KeyEvent: " + keyEventToString(keyEvent));
    if (keyEvent == null
